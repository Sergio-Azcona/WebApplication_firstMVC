...
namespace WebApplication_firstMVC.Controllers
{
    public class MoviesController : Controller
    {
        ...
        public MoviesController(WebApplication_firstMVCContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index(string searchString, string movieGenre)
        {
            ...
            { 
                Problem("Entity set 'WebApplication_firstMVCContext.Movie'  is null.");
            }
        ...
        public async Task<IActionResult> Create([Bind("Id,Title,ReleaseDate,Genre,Price,Rating, Language")] Movie movie)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Title,ReleaseDate,Genre,Price,Rating,Language")] Movie movie)
        {
            if (id != movie.Id)
            {
                return NotFound();
            ...
            if (ModelState.IsValid)
            {
                ...
                return RedirectToAction("Details", new { id = movie.Id });//changed redirecting page to details
            }
            return View(movie);
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            if (_context.Movie == null)
            {
                return Problem("Entity set 'WebApplication_firstMVCContext.Movie'  is null.");
            }
            var movie = await _context.Movie.FindAsync(id);
            if (movie != null)
            {
